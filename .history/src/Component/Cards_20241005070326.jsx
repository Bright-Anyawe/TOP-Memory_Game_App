...
function Card() {
 ...
 const request7 = fetch(
          "https://api.giphy.com/v1/stickers/translate?api_key=xUGeBWKikoUF1sOZRB6a37IK2KhrYt3e&s=Tho",
          { mode: "cors" }
        );
      try {
        const response = await Promise.all([request1, request2, request3, request4, request5, request6]);
