...
function Card({score, setScore, bestScore, setBestScore}) {
  const [cards, setCards] = useState([
    { url: "", name: "Spiderman", clickCard: null },
    { url: "", name: "Captain marvel",  clickCard: null },
    { url: "", name: "Black Panther", clickCard: null },
    { url: "", name: "Doctor Strange",  clickCard: null },
    { url: "", name: "Iron Man",  clickCard: null },
    { url: "", name: "Thor",  clickCard: null },
    { url: "", name: "Thanos",  clickCard: null },
    { url: "", name: "Xmen",  clickCard: null },
  ]);
...
const newClickedCard = card.clickCard ? card.clickCard + 1 : 1;
