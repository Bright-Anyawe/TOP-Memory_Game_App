...
const clickCardIndex = e.target.dataset.index;

setCards((prevCards) => 
prevCards.map((card, index) => 

if(index === clickCardIndex) {
  ...
  return (
     ...
     {cards.map((card, index ) => (
                  <li key={card.name} data-index={index} className="card" onClick={changeCardsPosition }>
                    {/* <h1> {key} </h1> */}
