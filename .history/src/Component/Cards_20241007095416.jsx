...
function Card({incrementScore, setScoreToZero, handleBestScore, handleBestScoreDisplay}) {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      const request10 = fetch(
        "https://api.giphy.com/v1/stickers/translate?api_key=xUGeBWKikoUF1sOZRB6a37IK2KhrYt3e&s=",
        { mode: "cors" }
      );
...
console.log(handleBestScoreDisplay())
